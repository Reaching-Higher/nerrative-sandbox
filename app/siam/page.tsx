  ...
  return (
    <section className="w-full flex items-center justify-center font-body text-light">
      <div className="w-5/6 h-4/5 grid grid-flow-col grid-rows-4 grid-cols-3 gap-1.5">
        <div className="row-span-2 col-span-2 bg-[#51107c] bg-opacity-30 p-4" />
        ...
        <div className="row-span-2 col-span-2 bg-[#5f3f74] bg-opacity-30 p-4 hover:bg-opacity-60" />
        <div className="row-span-2 col-span-2 bg-brandAccent bg-opacity-30 p-4 hover:bg-opacity-40">
          ...
          <a href="##" className="par-1 uppercase tracking-widest" />
          <a href="##" className="link-1 uppercase">
            Learn More <span className="ml-3">&rarr;</span>
          </a>
        </div>
        <div className="bg-[#69636d] bg-opacity-40 p-4 hover:bg-opacity-70" />
        ...
        <div className="bg-[#69636d] bg-opacity-30 p-4 hover:bg-opacity-60" />
        ...
        <div className="bg-[#69636d] bg-opacity-20 p-4 hover:bg-opacity-50" />
        ...
        <div className="bg-[#69636d] bg-opacity-10 p-4 hover:bg-opacity-40" />
